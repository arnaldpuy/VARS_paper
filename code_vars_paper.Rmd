...
```{r initial_settings, results="hide", message=FALSE, warning=FALSE}
...
```{r design_figure_final, cache=TRUE, dependson="functions", warning=FALSE, dev="tikz", fig.height=4, fig.width=4.5}
...
```{r liu_tikz, dev="tikz", cache=TRUE, fig.width=5.4, fig.height=2.2}
