...
We also code the Jansen estimator [@Jansen1999] (`jansen_ti`), and a function to compute Savage scores (`savage_scores`) [@Savage1956]. Finally, we code a function that allows to randomly transform the distribution of model inputs to normal, logitnormal or different beta distributions.
...
```{r merge_plots, cache=TRUE, dependson=c("scatter_uncertain", "histograms"), dev="tikz", fig.height=5, fig.width=4.3}
...
```{r median_ratios, cache=TRUE, dependson=c("arrange_output"), dev="tikz", fig.height=2.5, fig.width=5}
...
```{r diff_size, cache=TRUE, dependson = "arrange_output", dev="tikz", fig.height=1.8, fig.width=6}
...
```{r diff_size_hist, cache=TRUE, dependson = "arrange_output", dev="tikz", fig.height=2.5, fig.width=3}
