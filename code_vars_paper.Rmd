...
```{r plot_lit, cache=TRUE, dependson="cite_literature", dev="tikz", fig.width=5.5, fig.height=4}
...
```{r plot_literature, cache=TRUE, dependson="cite_literature", dev="tikz", fig.width=7, fig.height=2.5}
...
```{r plot_random_distributions, dependson="other_functions", cache=TRUE, dev="tikz", fig.width=4.5, fig.height=2.7, fig.cap="Distributions used in the metafunction."}
...
```{r plot_functions_metafunction, cache=TRUE, dependson="functions_metafunction", fig.height=2.7, fig.width=5, dev="tikz", fig.cap="Functions used in the metafunction of @Becker2019."}
...
```{r plot_six_dimensional, cache=TRUE, dependson="six_dimensional", dev="tikz", fig.height=2.2, fig.width=2.7}
...
```{r plot_mae, cache=TRUE, dependson="mae_computation", dev = "tikz", fig.height=2.5, fig.width=3}
...
````{r plot_together, cache=TRUE, dependson=c("plot_mae", "plot_six_dimensional"), dev = "tikz", fig.height = 2.5, fig.width = 5.5}
...
In this section we present the workflow of the analysis. The following code snippets are based on @Puyj.
...
### Arrange the results
We arrange the results as to allow further inspection. We also show the simulations that yielded `Na` or `NaN`, and substitute them for zeroes. We finally export the results to `.csv`.
...
```{r normal_distr, cache=TRUE, dependson="arrange_output", dev="tikz", fig.height=2.5, fig.width=3}
...
```{r diff_size, cache=TRUE, dependson = "arrange_output", dev="tikz", fig.height=1.8, fig.width=5, fig.cap="Line plot displaying the absolute difference between the total number of model runs allocated to Jansen and the total number of runs allocated to VARS-TO in each simulation."}
...
```{r export_indices, cache=TRUE, dependson="sobol_indices"}
